...
def get_rest_api_market_for_endpoint(trading_pair: Optional[str] = None) -> str:
    return (
        ...
        else CONSTANTS.NON_LINEAR_MARKET
    )
...
def rest_api_url_for_endpoint(endpoint: str, domain: Optional[str] = None) -> str:
    variant = domain or "bybit_perpetual_main"
...
def _wss_url(endpoint: Dict[str, str], connector_variant_label: Optional[str]) -> str:
    variant = connector_variant_label or "bybit_perpetual_main"
    ...
    return [
        ...
        RateLimit(
            ...
            linked_limits=[
                LinkedLimitWeightPair(CONSTANTS.POST_LIMIT_ID),
                LinkedLimitWeightPair(
                    pair_specific_linear_private_bucket_75_limit_id
                ),
            ],
        ),
        RateLimit(
        ...
        RateLimit(
            ...
            linked_limits=[
                LinkedLimitWeightPair(CONSTANTS.POST_LIMIT_ID),
                LinkedLimitWeightPair(
                    pair_specific_linear_private_bucket_100_limit_id
                ),
            ],
        ),
        RateLimit(
        ...
        RateLimit(
            ...
            linked_limits=[
                LinkedLimitWeightPair(CONSTANTS.GET_LIMIT_ID),
                LinkedLimitWeightPair(
                    pair_specific_linear_private_bucket_600_limit_id
                ),
            ],
        ),
        RateLimit(
